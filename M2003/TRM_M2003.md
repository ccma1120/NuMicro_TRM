...
style="width:5.92361in;height:2.73611in" />![](./media/media/image15.emf) |
|----|
...
| Supports total 4 Kbytes SRAMSupports byte / half word / word writeSupports oversize response error![](./media/media/image16.emf) |
|----|
...
![](./media/media/image38.emf)Figure 6.5‑3 Input Mode
...
| <span id="_Toc172017436" class="anchor"></span>Block Diagram![](./media/media/image52.emf) |
|----|
...
| Software writes CMPDAT DATA1 to CMPDAT at point 1. Hardware loads CMPDAT DATA1 to CMPBUF at the end of PWM period at point 2.Software writes PERIOD DATA1 to PERIOD at point 3.Hardware loads PERIOD DATA1 to PBUF at the end of PWM period at point 4.Software writes PERIOD DATA2 to PERIOD at point 5.Hardware loads PERIOD DATA2 to PBUF at the end of PWM period at point 6.![](./media/media/image64.emf) |
|----|
...
| <span id="_Toc172017444" class="anchor"></span>Block Diagram![](./media/media/image87.emf) |
|----|
...
| <span id="_Toc172017451" class="anchor"></span>Features6-bit down counter value (CNTDAT, WWDT_CNT\[5:0\]) and 6-bit compare value (CMPDAT, WWDT_CTL\[21:16\]) to make the WWDT time-out window period flexibleSupports 4-bit value (PSCSEL, WWDT_CTL\[11:8\]) to programmable maximum 11-bit prescale counter period of WWDT counterWWDT counter suspends in Idle/Power-down mode<span id="_Toc172017452" class="anchor"></span>Block Diagram![](./media/media/image90.emf) |
|----|
...
from low to high)<img src="./media/media/image106.emf" /></p>
...
from high to low)<img src="./media/media/image107.emf" /></p>
<p><strong>Note:</strong> Stable count means HCLK source recovery stable
count.</p></th>
</tr>
</thead>
...
src="./media/media/image108.emf" /></p>
...
<tr>
<th style="text-align: center;"><p><img
src="./media/media/image115.emf" /></p>
...
<tr>
<th style="text-align: center;"><p><img
src="./media/media/image116.emf" /></p>
...
(UART_ALTCTL[10]).<img src="./media/media/image117.emf" /></p>
...
src="./media/media/image162.emf" /></p>
